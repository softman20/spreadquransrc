...
?>
    <table height="510" cellspacing="0" cellpadding="0" border="0" align="center" width="602" dir="ltr">
	<tbody><tr style="background-image:url('http://prayers.jfntechnologie.com/tafsir_quran/img/p11.gif')">
		...
		<td style="background-image:url('http://prayers.jfntechnologie.com/tafsir_quran/img/p001_02.png');text-align:center">
        <br />        <br />        <br />        <br />
...
?>
  ...
  <a title="إضغط على الآية للحصول على التفاسير والترجمة ..." id="eya_<?= $eya?>"  onmouseout="if(document.getElementById('eyadiv_<?= $eya?>').getStyle('display')=='none') this.setClassName('ayaah')" onmouseover="this.setClassName('ayaah selected');" class="ayaah"><?= $eyaContent ?></a>
  <a class="ayaah number" style="cursor: pointer;"> ﴿<?= $eya ?>﴾ </a>	
    ...
    <div id='eyadiv_<?= $eya?>' class='popup' style='position:relative;  height: 180px; display:none; overflow: auto;'>
        <ul>
            ...
            <fb:mp3 width="130px" src="http://prayers.jfntechnologie.com/audio/ayah/Huzify/<?= $souraAjxMp3.$eyaMp3 ?>.mp3" title="الآية  <?= $eya ?> من سورة <?= $souraAjxName ?>" artist="عبدالرحمن حذيفي" album="القرآن الكريم" />
            </div>
            <div style="display:inline-block;margin-left:5px;margin-right:5px">
            <fb:mp3 width="130px" src="http://prayers.jfntechnologie.com/audio/ayah/Menshawi/<?= $souraAjxMp3.$eyaMp3 ?>.mp3" title="الآية <?= $eya ?> من سورة <?= $souraAjxName ?>" artist="محمد صديق المنشاوي" album="القرآن الكريم" />
            </div>
           
             <div style="display:inline-block">
            <fb:mp3 width="130px" src="http://74.86.30.138/~quran/quran/mp3/muaiqly_<?= floor($souraAjxMp3)."_".floor($eyaMp3)."_".floor($eyaMp3) ?>.mp3" title="الآية <?= $eya ?> من سورة <?= $souraAjxName ?>" artist="ماهر المعيقلي" album="القرآن الكريم" />
            </div>
            </li>
...
<div id="dialog_title_trans" style="text-align:center;font-size:15px">  
	...
	<tr>
		...
		<td>
			<img height="215" width="445" alt="" src="http://prayers.jfntechnologie.com/tafsir_quran/img/p001_08.gif"></td>
		<td>
